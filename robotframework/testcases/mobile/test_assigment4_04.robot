...
*** Test Cases ***
TC03 Verify cannot edit note with empty title
    home_page.Verify page is home page
    home_page.Tap add note button
    add_note_page.Add note title    ${mobile_data.TC04.title}
    add_note_page.Click add button
    home_page.Verify note should be visible  ${mobile_data.TC04.title}
    home_page.Tap note by note title   ${mobile_data.TC04.title}
    add_note_page.Add note title    ${mobile_data.TC04.new_title}
    add_note_page.Click add button
    home_page.Verify note should be visible  ${mobile_data.TC04.title}
